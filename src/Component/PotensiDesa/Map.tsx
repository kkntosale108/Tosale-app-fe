...
const Map = () => {
  return (
    <MapContainer
      center={[-0.7686540224075663, 119.68242286925576]}
      zoom={13}
    ...
    >
      ...
      />
      <Marker
        position={[-0.7686540224075663, 119.68242286925576]}
        icon={markerIcon}
      >
        <Popup className="w-96">
          <img
            width={400}
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6AonIbwx-FbVesY6meMTZKD04ME6JVqPTZQ&s"
            alt=""
          />
          <p>Ini adalah Tosale</p>
        </Popup>
      </Marker>
      <Marker
        icon={markerIcon}
        position={[-0.7558589326761213, 119.68146047864242]}
      >
        <Popup className="w-96">
          <img
            width={400}
